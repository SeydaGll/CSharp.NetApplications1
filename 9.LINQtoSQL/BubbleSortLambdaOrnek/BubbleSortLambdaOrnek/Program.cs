...
namespace BubbleSortLambdaOrnek
{
    delegate bool SiralamaKarsilastirma<Tip>(Tip ilkDeger, Tip sonDeger);  // delegate...
    class Program
    {
    ...
    //    {
    //        return i1 < i2; // buradaki mantıksal ifade sayesinde true yada false değeri dönecektir...
    //    }
    //}
